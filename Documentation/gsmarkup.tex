...
\item {\bf ttt textColor}: a color attribute that determines the color
  used to draw the text.
\item {\bf ttt selectable}: a boolean attribute that determines if the
...
following ones:
\begin{itemize}
\item {\bf ttt allowsEditingTextAttributes}: a boolean attribute.
  When set to yes, the user can edit the font and text attributes of
  the text displayed in the text field.
\item {\bf ttt backgroundColor}: a color attribute that determines the
  color of the background.
\item {\bf ttt drawsBackground}: a boolean attribute that controls
  whether the text field draws its background or not.  Useful in
  conjunction with 'backgroundColor' if you want to control the text
  field colors.
\item {\bf ttt editable}: a boolean attribute that determines if the
  text field is editable or not (that is, if the user can edit the
  text within the text field).  Text fields are editable by default.
\item {\bf ttt importsGraphics}: a boolean attribute.  When set to
  yes, the user can drag image files into the text field.
\item {\bf ttt selectable}: a boolean attribute that determines if the
